    ...
    return (
        <div>
            ...
            <div id="text_area">
                ...
                <div class="subtitle desktop_div">
                    ...
                    <p>We've only just begun, we'd love your <a href="javascript:;" class="feedback_lnk">feedback</a> and participation.</p>
                </div>

                <div class="subtitle mobile_div">
